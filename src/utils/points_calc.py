...
def calculate_fantasy_points(pc: PointsConfig, qb_yd, qb_td, int, rec_yd, rec_td, rush_yd, rush_td, fumble):
    ...
    return (qb_yd_bonus_pts + qb_yd_pts + qb_td_pts + int_pts + rec_yd_bonus_pts + rec_yd_pts + rec_td_pts +
